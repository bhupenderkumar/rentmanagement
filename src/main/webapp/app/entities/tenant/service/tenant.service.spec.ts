...
describe('Tenant Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      tenantName: 'AAAAAAA',
      addressProffContentType: 'image/png',
      addressProff: 'AAAAAAA',
      numberofFamilyMembers: 0,
      phoneNumber: 'AAAAAAA',
      rentStartDate: currentDate,
      rentAmount: 0,
      electricityUnitRate: 0,
      startingElectricityUnit: 0,
      anyOtherDetails: 'AAAAAAA',
      sendNotification: false,
      emailAddress: 'AAAAAAA',
      emergencyContactNumber: 'AAAAAAA',
      outStandingAmount: 0,
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          rentStartDate: currentDate.format(DATE_FORMAT),
        },
        elemDefault
      );
      ...
      const returnedFromService = Object.assign(
        {
          ...
          rentStartDate: currentDate.format(DATE_FORMAT),
          rentAmount: 1,
          electricityUnitRate: 1,
          startingElectricityUnit: 1,
          anyOtherDetails: 'BBBBBB',
          sendNotification: true,
          emailAddress: 'BBBBBB',
          emergencyContactNumber: 'BBBBBB',
          outStandingAmount: 1,
