...
import com.rentmanagement.repository.RoomRepository;
...
class RoomResourceIT {
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().roomName(DEFAULT_ROOM_NAME).floor(DEFAULT_FLOOR);
        // Add required entity
        Building building;
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().roomName(UPDATED_ROOM_NAME).floor(UPDATED_FLOOR);
        // Add required entity
        Building building;
        if (TestUtil.findAll(em, Building.class).isEmpty()) {
    ...
    void putNewRoom() throws Exception {
        ...
        updatedRoom.roomName(UPDATED_ROOM_NAME).floor(UPDATED_FLOOR);
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.floor(UPDATED_FLOOR);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomName(UPDATED_ROOM_NAME).floor(UPDATED_FLOOR);
